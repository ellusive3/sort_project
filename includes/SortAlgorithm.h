...
namespace Sort {
	...
	*/
    ...
    /**
	@short
	    Декларация класса алгоритма сортировки массива вставками
    */
    ...
    */
	...
	public:
	    ...
	    */
	    ...
	    /**
		@short
		    Декларация класса узла дерева
	    */
	    struct Node {
			// Значение
			int key;
			// Указатели на следующий и предыдущий узлы
		...
		*/	    
		...
		/**
			...
			@param[in] node - указатель на соседний узел 
			@param[in] key - значение узла
		*/
	    static Node * Insert(Node * node, int key);

		/**
			@short
				Переместить значения из дерева с массив
			@param[in] root - указатель на корневой узел
			@param[in] array - указатель на массив значений
			@param[in] i - индекс элемента в массиве
		*/
